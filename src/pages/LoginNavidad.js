...
const LoginNavidad = () => {
	...
	return (
		<section className="flex items-center justify-center min-h-screen relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #0b3d2e 0%, #14532d 45%, #052e1c 100%)' }}>
			...
			{/* Guirnaldas alrededor del fondo */}
			<div className="hidden md:block absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none" style={{
				width: '62%',
				aspectRatio: '16/9',
			}}>
				{/* Guirnalda superior */}
				<div className="absolute -top-8 left-0 right-0 flex justify-center">
					<div className="flex items-center" style={{
						background: 'linear-gradient(90deg, transparent, #0f5132, #166534, #0f5132, transparent)',
						padding: '8px 0',
						borderRadius: '50px',
						width: '100%',
					}}>
				...
				{/* Guirnalda izquierda */}
				<div className="absolute -left-8 top-0 bottom-0 flex flex-col justify-center">
					<div className="flex flex-col items-center" style={{
						background: 'linear-gradient(180deg, transparent, #0f5132, #166534, #0f5132, transparent)',
						padding: '0 8px',
						borderRadius: '50px',
						height: '100%',
					}}>
				...
				{/* Moños esquinas */}
				<div className="absolute -top-4 -left-4 text-4xl animate-pulse" style={{
				...
				<div className="absolute -bottom-4 -left-4 text-4xl animate-pulse" style={{
					animationDelay: '1s',
					filter: 'drop-shadow(0 4px 8px rgba(220, 20, 60, 0.6))',
				}}>🎀</div>
				<div className="absolute -bottom-4 -right-4 text-4xl animate-pulse" style={{
					animationDelay: '1.5s',
					filter: 'drop-shadow(0 4px 8px rgba(220, 20, 60, 0.6))',
				}}>🎀</div>
			</div>
