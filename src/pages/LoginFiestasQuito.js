	  ...
	  {[...Array(30)].map((_, i) => {
		...
		<div className="absolute top-0 left-0 right-0 h-20 flex justify-around">
		  {[...Array(15)].map((_, i) => (
			<div
			  key={i}
			  className="w-3 h-8 rounded-full animate-pulse"
			  style={{
				background: i % 2 === 0 ? '#003DA5' : '#DC143C',
				animationDelay: `${i * 0.15}s`,
				boxShadow: `0 0 20px ${i % 2 === 0 ? '#003DA5' : '#DC143C'}`,
			  }}
			/>
		  ))}
		</div>

		{/* Chiva quiteña animada */}
		<div className="absolute bottom-10 w-full overflow-hidden pointer-events-none">
		  <div className="animate-chiva" style={{
			animation: 'chivaDrive 20s linear infinite',
		  }}>
			{/* Cuerpo de la chiva */}
			  ...
			  <div className="relative">
				...
				<div className="w-32 h-16 bg-gradient-to-r from-red-600 to-red-700 rounded-t-lg relative" style={{
				  ...
				  <div className="absolute top-2 left-2 right-2 flex gap-1">
					{[...Array(4)].map((_, i) => (
					  <div key={i} className="flex-1 h-8 bg-blue-400 rounded-sm border border-blue-600" />
					))}
				  </div>
				  {/* Detalles decorativos */}
				  <div className="absolute bottom-1 left-2 right-2 h-1 bg-yellow-400" />
				</div>
				{/* Techo */}
				<div className="w-32 h-4 bg-red-800 rounded-t-lg absolute -top-4 left-0" />
				{/* Ruedas */}
				...
				{/* Faros */}
				<div className="absolute bottom-6 -right-1 w-2 h-2 bg-yellow-300 rounded-full animate-pulse" />
				{/* Texto decorativo */}
				<div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white font-bold text-xs whitespace-nowrap">
				  ¡QUITO!
				</div>
			  </div>
			</div>
		...
		{/* Banderines de Quito - Colores representativos azul y rojo */}
		<div className="absolute top-10 left-0 right-0 h-16 flex justify-center gap-1">
		  {[...Array(20)].map((_, i) => (
			<div
			  key={i}
			  className="relative"
		...
		{showPassword ? (<img
			  ...
			  style={{
				  ...
				  objectFit: 'contain',
				  borderRadius: '24px',
				  boxShadow: '0 0 50px rgba(255, 107, 107, 0.6), 0 0 100px rgba(78, 205, 196, 0.4)',
        ...
        <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 max-w-xs z-10">
          <div className="bg-white rounded-2xl p-6 shadow-2xl relative overflow-hidden" style={{
			boxShadow: '0 0 30px rgba(255, 107, 107, 0.5), 0 0 60px rgba(78, 205, 196, 0.3)',
			border: '2px solid rgba(255, 230, 109, 0.4)',
		  }}>
			{/* Decoración superior del card */}
			<div className="absolute top-0 left-0 right-0 h-2" style={{
			  background: 'linear-gradient(90deg, #003DA5, #DC143C, #0052CC, #FF1744, #003DA5)',
            ...
            <div className="text-center mb-6 relative">
			  {/* Mini fuegos artificiales decorativos */}
			  <div className="absolute -top-2 left-1/4 w-3 h-3 rounded-full animate-bounce" style={{ background: '#003DA5', boxShadow: '0 0 10px #003DA5' }}></div>
			  <div className="absolute -top-2 right-1/4 w-3 h-3 rounded-full animate-bounce" style={{ animationDelay: '0.2s', background: '#DC143C', boxShadow: '0 0 10px #DC143C' }}></div>
              ...
              />
              <h2 className="text-lg font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-700 via-red-600 to-blue-700">
			    🎆 Fiestas de Quito 2025 🎆
			  </h2>
			  <p className="text-xs mt-1 font-semibold" style={{ color: '#003DA5' }}>¡Celebremos juntos!</p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <button
                type="submit"
                className="w-full text-white py-2.5 px-4 rounded-xl font-semibold hover:brightness-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-300 text-sm mt-4 relative overflow-hidden group"
				style={{
  				  backgroundImage: 'linear-gradient(90deg, #003DA5, #DC143C, #0052CC, #FF1744, #003DA5)',
				  backgroundSize: '200% 100%',
				  animation: 'gradientShift 3s linear infinite',
  				}}
              >
...
export default LoginFiestasQuito;