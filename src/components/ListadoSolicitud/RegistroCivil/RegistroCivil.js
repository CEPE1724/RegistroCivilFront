              ...
              <div className="relative group w-full lg:w-1/2 max-w-md">
                ...
                <div className="relative bg-white rounded-lg overflow-hidden shadow-xl">
                  <div className="bg-green-600 text-white py-3 px-4 font-semibold text-center">
                    <span className="flex items-center justify-center gap-2">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M10 2a8 8 0 100 16 8 8 0 000-16zm-3.707 9.293a1 1 0 011.414 0L9 12.586l4.293-4.293a1 1 0 111.414 1.414l-5 5a1 1 0 01-1.414 0l-2-2a1 1 0 010-1.414z" clipRule="evenodd" />
                      </svg>
