...
const todosTitularesContactados = titulares.every((item) => item.idEstadoGestns === 11);
console.log("todos titulares", todosTitularesContactados)
              ...
              <div className="md:w-3/4 mt-6 pl-4 bg-white shadow-xl rounded-lg p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-base leading-relaxed">
                  ...
                  <div className="flex flex-wrap gap-4 items-center">
                    {resultContactedDocs.length >= 2 && tienePermisoValidar && clientInfo.idEstadoVerificacionTelefonica !== 3 && todosTitularesContactados &&(
                      <button
