    ...
    return (
         <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
            <div className="p-8 border-b-2 border-gray-100">
                <h2 className="text-2xl font-bold text-gray-900">Tipos de Score <span className="text-blue-600">(Score: {scoresCobranzas.find(s => s.idCbo_Scores_Cobranzas === scoreSeleccionado)?.Descripcion})</span></h2>
                <p className="text-gray-600 mt-1">Configuración de tipos de score  seleccionado: <span className="font-bold text-blue-600">{scoreResultadoFiltrado.length} registros</span></p>
            </div>
                ...
                <table className="w-full">
                    <thead>
                        <tr className="bg-gradient-to-r from-slate-800 to-slate-900 text-white">
                            ...
                            <th className="px-6 py-4 text-left text-xs font-bold uppercase">Peso</th>
                            <th className="px-6 py-4 text-center text-xs font-bold uppercase">Resultado</th>
