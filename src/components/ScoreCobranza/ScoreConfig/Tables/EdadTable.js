    ...
    return (
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
            <div className="p-8 border-b-2 border-gray-100">
                ...
                <p className="text-gray-600 mt-1">Configuración de tipos de edad para score seleccionado: <span className="font-bold text-blue-600">{edadFiltrada.length} registros</span></p>
            </div>
