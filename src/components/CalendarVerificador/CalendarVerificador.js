                    ...
                    <div className="grid grid-cols-8 gap-2">
                      ...
                      {days.map((day, index) => {
                        ...
                        const dayEditable = fechaDia
                          ? hours.some((hour) => isEditableCell(fechaDia.fullDate, hour))
                          : false;
                        ...
                        return (
                          ...
                          >
                            ...
                            {dayEditable && (
                              <select
                                onChange={(e) =>
                                  handleDayBulkChange(day, e.target.value)
                                }
                                defaultValue=""
                                className="text-xs border rounded px-1 py-0.5 bg-white shadow-sm text-gray-700"
                              >
