...
import {
  ...
  fetchProvincias, fetchCantones, fetchParroquias, fetchBarrios
} from "./apisFetch";
import { FaCalendarAlt, FaIdCard, FaStore, FaUserAlt, FaEnvelope, FaPhoneAlt, FaCog, FaUser, FaMapMarkerAlt } from "react-icons/fa";
        ...
        <form>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:grid-cols-5">
              ...
              <div className="col-span-1">
                <label className="text-xs font-medium mb-1 flex items-center">
                  <FaStore className="mr-2 text-primaryBlue" />Nacionalidad
                </label>
                <select
              ...
              <div className="col-span-1">
                <label className="text-xs font-medium mb-1 flex items-center">
                  <FaCalendarAlt className="mr-2 text-primaryBlue" /> {/* Icon for date */}
                  Fecha Nacimiento
                </label>
                <input
                  type="date"
              ...
              <div className="col-span-1">
                <label className="text-xs font-medium mb-1 flex items-center">
                  <FaUserAlt className="mr-2 text-primaryBlue" /> {/* Icon for gender */}
                  Género
                </label>
                <select
                  className="solcitudgrande-style"
              ...
              <div className="col-span-1">
                <label className="text-xs font-medium mb-1 flex items-center">
                  <FaMapMarkerAlt className="mr-2 text-primaryBlue" /> {/* Icon for location */}
                  Provincia Nacimiento
                </label>
                <select
                  className="solcitudgrande-style"
              ...
              {/* Profesion */}
              <div className="col-span-1">
                <label className="text-xs font-medium mb-1 flex items-center">Profesion</label>
                <select
                  className="solcitudgrande-style"
                  onChange={handleFormChange}
                  name="profesion"
          ...
          <div className="py-2 w-full mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:grid-cols-4">
              {/* Provincia */}
              <div className="col-span-1">
                <label className="text-xs font-medium mb-1 flex items-center">Provincia</label>
                <select
                  className="solcitudgrande-style"
                  onChange={handleFormChange}
                  name="provincia"
              ...
              {/* Canton */}
              <div className="col-span-1">
                <label className="text-xs font-medium mb-1 flex items-center">Canton</label>
                <select
                  className="solcitudgrande-style"
                  onChange={handleFormChange}
                  name="canton"
              ...
              {/* Parroquia */}
              <div className="col-span-1">
                <label className="text-xs font-medium mb-1 flex items-center">Parroquia</label>
                <select
                  className="solcitudgrande-style"
                  onChange={handleFormChange}
                  name="parroquia"
              ...
              {/* Barrio */}
              <div className="col-span-1">
                <label className="text-xs font-medium mb-1 flex items-center">Barrio</label>
                <select
                  className="solcitudgrande-style"
                  onChange={handleFormChange}
                  name="barrios"
              ...
              {/* Numero Casa */}
              <div className="col-span-1">
                <label className="text-xs font-medium mb-1 flex items-center">Numero Casa</label>
                <input
                  type="text"
                  className="solcitudgrande-style"
                  name="numeroCasa"
          ...
          <div className="py-2 w-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:grid-cols-4">
              ...
              {/* Inmueble */}
              <div className="col-span-1">
                <label className="text-xs font-medium mb-1 flex items-center">Inmueble</label>
                <select
                  className="solcitudgrande-style"
                  name="inmueble"
                  onChange={handleFormChange}
