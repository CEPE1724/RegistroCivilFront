...
import {
	FaStar, FaChartLine, FaFileInvoiceDollar, FaUserCheck, FaHandHoldingUsd, FaChartPie,
...
const InformacionCredito = forwardRef((props, ref) => {
	...
	const [formData, setFormData] = useState({
		score: data.Score,
		rangeIngresos: data.RangoIngresos,
		resultadoEquifax: data.ResultadoEquifax,
		scoreInclusion: data.ScoreInclusion,
		capacidadPago: data.CapacidadPago,
		segmentacionEquifax: data.SegmentacionEquifax,
		scoreSobreendeudamiento: data.ScoreSobreendeudamiento,
		totalVencido: data.TotalVencido,
		carteraCastigada: data.CarteraCastigada,
	});
